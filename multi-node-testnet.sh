...
yes 12345678 | sequencerd gentx  testnet0 1000000000000000000000aseq --home data/testnet/zkevm-sequencer-0  --keyring-backend os --chain-id testnet_9000-1
yes 12345678 | sequencerd gentx  testnet1 1000000000000000000000aseq --home data/testnet/zkevm-sequencer-1  --keyring-backend os --chain-id testnet_9000-1
yes 12345678 | sequencerd gentx  testnet2 1000000000000000000000aseq --home data/testnet/zkevm-sequencer-2  --keyring-backend os --chain-id testnet_9000-1
